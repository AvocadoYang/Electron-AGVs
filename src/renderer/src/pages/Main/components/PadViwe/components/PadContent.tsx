import { OpenCarCardInfo, OpenMissionCardInfo, viewBtn } from '@renderer/pages/Main/global/jotai';
...
const PadContent = () => {
  ...
  const [openMissionCardInfo, setOpenMissionCardInfo] = useAtom(OpenMissionCardInfo);
