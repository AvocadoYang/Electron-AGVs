...
import useConveyorSocket from '@renderer/sockets/useConveyorSocket';
...
const PointDiv = styled.div.attrs<{
  ...
  width: 5px;
  height: 5px;
  background: ${(props) => (props.canrotate === 'true' ? '#ebac5b' : '#71ce00')};
  border-radius: 50%;
  z-index: 10;
            ...
            >
              ...
              <WrapperStation left={displayX} top={displayY}>
                <ConveyorIcon
                  ...
                  rotate={rotate}
                  scale={LocScale}
                  info={conveyorData?.find((s) => s.locationId === loc.locationId) || null}
                />
              </WrapperStation>
            </div>
          );
