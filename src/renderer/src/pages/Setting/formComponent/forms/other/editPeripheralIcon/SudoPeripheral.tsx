...
import usePeripheralStyle from '@renderer/api/usePeripheralStyle';
...
const SudoPeripheral = () => {
  ...
  const { data: defaultData } = usePeripheralStyle(selectStation?.peripheralType || null);
  ...
  if (selectStation.peripheralType === 'Charging') {
    return (
      <ChargingStationContainer left={left} top={top} key={selectStation.loc}>
        ...
        >
          <PeripheralIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
